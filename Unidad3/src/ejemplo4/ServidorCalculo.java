...
public class ServidorCalculo {
	...
	public int extraerNumero(String linea) {
		/*
		 * 1. Comprobar si es un n�mero 2. Ver si el n�mero es correcto (32a75) 3. Ver
		 * si tiene de 1 a 8 cifras
		 */
		int numero;
		try {
		...
		/*
		 * Si el n�mero es mayor de 100 millones no es v�lido tampoco
		 */
		if (numero >= 100000000) {
			numero = 0;
		}
