...
public class GestorEmail {
	...
	throws NoSuchProviderException,MessagingException{
		...
		//Una vez construido el mensaje utilizamos la clase Transport para enviarlo, normalmente a trav�s del protocolo SMTP
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Introduce direcci�n de correo");
			...
			*/
			...
			gestorEmail.enviarMensajeTexto(emailEmisor, 
										  ...
										  "Aviso tarea", 
										  "Tiene ma�ana una tarea para PSP", 
